...
sys.path.append('/home/lyu/ExpRank/models/')
sys.path.append('/home/lyu/ExpRank/utilities/')
from base_model import BaseRanker
from dataIterBert import PointwiseTrainDataset, PairwiseTrainDataset, ValTestDataset, Batch
